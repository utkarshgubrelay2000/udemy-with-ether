...
// When the user clicks on the link to reset their password from their email,
// they are taken to this page where they enter their email, new passoword and confirm password
// then a post requesrt is made to user-manager and their credentials are updated. 
...
export default () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (resp) {
            ...
            // console.log("User", "Failed Submission", "Reset Password Error");

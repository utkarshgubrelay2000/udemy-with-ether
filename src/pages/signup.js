    ...
    <Container fluid className="px-0" style={{ marginTop: "74px" }}>
      ...
      <Row className="min-vh-100 mx-0 overflow-hidden">
        <Col md="8" lg="6" xl="5" className="d-flex align-items-center">
          ...
          {
              courseRedirectError &&
              <div style={{ marginBottom: '5%', marginLeft: '1%', display: 'flex', flexDirection: 'row', justifyContent: 'space-around', width: '80%', }}>
                <i className="fas fa-exclamation-circle text-danger" style={{ fontSize: 50 }}></i>
                <text className="text-danger" style={{  marginLeft: '3%', fontWeight: 900 }}>
                  It looks like you've ran out of the amount of courses you can view.
                  Sign up to view all the courses you want now!
                </text>
              </div>
          }
          {
            ...
            <div style={{ marginBottom: '5%', marginLeft: '1%', display: 'flex', flexDirection: 'row', justifyContent: 'space-around', width: '80%', }}>
              <i className="fas fa-exclamation-circle text-danger" style={{ fontSize: 50 }}></i>
              <text className="text-danger" style={{  marginLeft: '3%', fontWeight: 900 }}>
                It looks like you've ran out of the amount of jobs you can view.
                Sign up for FREE to view as many jobs as you want now!
              </text>
            </div>
          }
            <div className="mb-4">
              ...
              <p className="text-primary" style={{ fontWeight: 600 }}>
                ...
                <text className="text-primary" style={{ fontWeight: 400 }}>
                  {" "}To help you get started on your journey, we just need some basic info.
                </text>
              </p>
              <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                <span className="badge bg-primary" style={{ height: '80%', alignSelf: 'center', marginRight: '2%' }}>
                  <i class="fas fa-binoculars" style={{ color: 'white' }}></i>
                </span>
                <text className="text-muted" style={{ display: 'block'}}>
                  Discover over <strong>15,000</strong> courses from leading course providers like Treehouse, SkillShare, and more.
                </text>
              </div>
              <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                <span className="badge bg-primary" style={{ height: '80%', alignSelf: 'center', marginRight: '2%' }}>
                ...
                <text className="text-muted" style={{ display: 'block', marginTop: '2%'}}>
                  Use our search engine and bookmark courses that you want to save for later.
                </text>
              </div>
              <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                <span className="badge bg-primary" style={{ height: '80%', alignSelf: 'center', marginRight: '2%'  }}>
                ...
                <text className="text-muted" style={{ display: 'block', marginTop: '2%' }}>
                  Search, compare, and apply to your dream job all in one place with our new Job Portal
                </text>
              </div>
            </div>
